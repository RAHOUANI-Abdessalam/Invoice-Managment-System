...
public class ListeDuProduitsController implements Initializable {
    ...
    @FXML
    private HBox listeDeProduitsTxt;
    @FXML
    ...
    private void btnImprimmer(){
            ...
            if(printerJob.showPrintDialog((Stage) close.getScene().getWindow()) && printerJob.printPage(listeDeProduitsTxt) && printerJob.printPage(tableproduit))
                printerJob.endJob();
    }
